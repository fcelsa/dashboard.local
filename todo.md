...
## FX-Card
- Redesign and modify functionality of daily trends
...
- bug whit RATE key, need better error handling.
- Extend stack memory to 10 elements, then add M -> M combination key to print MIN MAX AVERAGE value of the stack.
- Logic business needs to change for better handling of % .
